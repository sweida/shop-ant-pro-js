                              ...
                              >
                                {getFieldDecorator(control.name, {
                                  ...
                                  <Checkbox.Group style={control.style}>
                                    {!!control.list &&
                                      control.list.map((value: any) => {
                                        return (
                                          <Checkbox value={value.value}>{value.name}</Checkbox>
                                        );
                                      })}
                                  </Checkbox.Group>,
                                )}
                          ...
                          if (control.componentName == 'select') {
                            if (control.mode) {
                              return (
                                ...
                                >
                                  {getFieldDecorator(control.name, {
                                    initialValue: control.value ? control.value : undefined,
                                    rules: control.rules,
                                  })(
                                    <Select
                                      mode={control.mode}
                            ...
                            return (
                              ...
                              >
                                {getFieldDecorator(control.name, {
                                  ...
                                  <Switch
                                    style={control.style}
                                    checkedChildren={control.checkedChildren}
                                    unCheckedChildren={control.unCheckedChildren}
                                  />,
                                )}
                              </Form.Item>
                            );
                            ...
                            return (
                              ...
                              >
                                {getFieldDecorator(control.name, {
                                  ...
                                  trigger: 'onCheck',
                                })(<Tree checkable>{renderTreeNodes(control.list)}</Tree>)}
                              </Form.Item>
                            );
                          }
                          ...
                          if (control.componentName == 'button') {
                            return (
                              ...
                              >
                                ...
                                {!!control.extendButtons &&
                                  control.extendButtons.map((extendButton: any) => {
